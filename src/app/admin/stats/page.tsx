    ...
    try {
        ...
        return (
            <div className="p-12 bg-slate-900/50 border border-white/5 rounded-2xl text-center shadow-2xl">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Error de Estadísticas (v1.0.4)</h2>
                <p className="text-slate-400 max-w-md mx-auto mb-8">
                    No pudimos procesar los datos de ventas en este momento. Intenta cambiar el período de tiempo o refrescar la página.
                </p>
