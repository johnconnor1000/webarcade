        ...
        <>
            ...
            <header className="lg:hidden h-16 border-b border-white/5 bg-slate-950 flex items-center justify-between px-4 fixed top-0 left-0 right-0 z-40">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[8px] px-1.5 py-0.5 rounded bg-white/5 border border-white/10 text-slate-600 font-mono leading-none">v1.0.8-FORCE-REDEPLOY</span>
                </div>
                <button
            ...
            `}>
                <div className="p-6 h-16 hidden lg:flex items-center border-b border-white/5">
                    ...
                    <span className="ml-2 text-[9px] px-1.5 py-0.5 rounded bg-white/5 border border-white/10 text-slate-600 font-mono leading-none">v1.0.8-FORCE-REDEPLOY</span>
                </div>
